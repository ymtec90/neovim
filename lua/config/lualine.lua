-- Eviline config for lualine with a small change
-- Author: ymtec90
-- Credit: glepnir and shadmansaleh
...
local function status_diagnostic()
  ...
  -- Return the filetype if msgs is empty and coc_status is also empty
  local status = vim.g.coc_status or ''
  if #msgs == 0 and status == '' then
